                ...
                <div class="d-grid gap-2 ps-5 pe-2">
                    <div class="row g-1 rounded-3 overflow-hidden">
                        <div class="col-6 mt-0">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-1.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                        <div class="col-6 mt-0">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-3.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-2.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-4.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-6.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src='<?= $PATH_ASSET_IMG . "megamenu/img-5.jpg" ?>' alt="thumbnails" loading="lazy">
                        </div>
                    </div>
