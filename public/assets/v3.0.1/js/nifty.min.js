...
document.querySelectorAll("[data-view]").forEach((t) => {
    t.addEventListener("click", (e) => {
        t.targetEl || ((e = e.target.closest(e.target.getAttribute("data-view-target")) || document.querySelector(e.target.getAttribute("data-view-target"))), (t.targetEl = e)),
            "fullscreen" == t.getAttribute("data-view")
                ? t.classList.contains("active")
                    ? t.targetEl.requestFullscreen
                        ? t.targetEl.requestFullscreen()
                        : t.targetEl.webkitRequestFullscreen && t.targetEl.webkitRequestFullscreen()
                    : document.exitFullscreen
                    ? document.exitFullscreen()
                    : document.webkitExitFullscreen && document.webkitExitFullscreen()
                : (t.targetEl.classList.toggle("content-full-page"), body.classList.toggle("body-sc"));
    });
}),
    document.querySelectorAll(".btn-close-card").forEach((t) => t.addEventListener("click", (e) => t.closest(".card").remove())),
...
mainNav &&
    ...
    (miniNavContentsCollapse = miniNavContents.map((e) => {
        if (e.parentElement.querySelector(".mininav-toggle.active") && (!isMiniNav || window.innerWidth < 992)) {
            ...
            var t = new bootstrap.Collapse(e, { toggle: !0 });
            return e.addEventListener("transitionend", () => n.classList.remove("open"), { once: !0 }), t;
        }
        return new bootstrap.Collapse(e, { toggle: !1 });
    })));
const popperOptions = { placement: "right-start", strategy: "fixed", modifiers: [{ name: "offset", options: { offset: [0, 2] } }] },
    updateNav = () => {
    ...
    addVariables = (e) => {
        ...
        (e._mainnav = {
            ...
            (e._mainnav.target.toggler = e)._mainnav.target.addEventListener("show.bs.collapse", bsCollapseShow),
    ...
    toggleContent = (e) => {
        if (!e.target._mainnav.target.classList.contains("nav-label") || (isMiniNav && !(window.innerWidth < 992))) {
            ...
            t.islink && e.preventDefault(),
                ...
                ["click", "touchend"].forEach((e) => document.addEventListener(e, hideAllMiniNavContent, { once: !0 }));
        }
    },
    buildNav = () => {
        isMiniNav = root.classList.contains("mn--min");
        let e = null;
        isMiniNav || (e = mainNav.querySelector(".has-sub > .mininav-toggle.nav-link.active + .mininav-content.nav")),
                ...
                t._mainnav || addVariables(t),
                    ...
                    !isMiniNav || window.innerWidth < 992
                        ? (t.addEventListener("click", toggleContent),
                          ["mouseenter", "touchend"].forEach((e) => t.removeEventListener(e, toggleContent)),
                          null != t._mainnav.target.popper && (t._mainnav.target.popper.setOptions({ scroll: !1, resize: !1 }), t._mainnav.target.popper.destroy()),
                          t._mainnav.target.addEventListener("hide.bs.collapse", bsCollapseHide))
                        : (miniNavContentsCollapse.map(async (e) => e.hide()),
                          (t._mainnav.target.popper = Popper.createPopper(t, t._mainnav.target, popperOptions)),
                          t.removeEventListener("click", toggleContent),
                          ["mouseenter", "touchend"].forEach((e) => t.addEventListener(e, toggleContent)),
                          t._mainnav.target.removeEventListener("hide.bs.collapse", bsCollapseHide));
            });
    };
...
if (document.getElementById("_dm-settingsContainer")) {
    ...
    f.boxedLayoutRadio.addEventListener("changed", (e) => {
        e.target.checked && !body.classList.contains("boxed-layout")
            ? (body.classList.add("boxed-layout"), h.classList.remove("opacity-50"), g.removeAttribute("disabled"))
            : (body.classList.remove("boxed-layout"), body.removeAttribute("style"), h.classList.add("opacity-50"), g.setAttribute("disabled", !0));
    }),
    ...
    const y = (e) => {
            ...
            return t.setAttribute("rel", "stylesheet"), t.setAttribute("href", e), t.addEventListener("load", A, { once: !0 }), t;
        },
        z = (e, o) => {
            let a = `${u}/v3.0.1/css/color-schemes/${e}/${o}.min.css`;
            // let a = `https://themeon.net/nifty/v3.0.1/assets/css/color-schemes/${e}/${o}.min.css`;
            // console.log(a);
    ...
    p.map((c) => {
        c.addEventListener("click", (t) => {
            if (!c.classList.contains("active")) {
                ...
                r("nifty.").parentNode.replaceChild(o, r("nifty.")),
    ...
    let d, c;
    const D = { className: "os-nifty-minimal", scrollbars: { autoHide: "leave", clickScrolling: !0 }, overflowBehavior: { x: "visible-scroll" } },
        E = () =>
            new Promise((t, o) => {
                if (document.getElementById("_dm-jsOverlayScrollbars")) t("done");
                    ...
                    e.setAttribute("id", "_dm-cssOverlayScrollbars"),
                        ...
                        e.setAttribute("href", `${u}/vendors/overlayscrollbars/overlayscrollbars.min.css`),
                        document.querySelector("head").append(e),
                        (e = document.createElement("script")),
                        e.setAttribute("id", "_dm-jsOverlayScrollbars"),
                        e.setAttribute("src", `${u}/vendors/overlayscrollbars/OverlayScrollbars.min.js`),
